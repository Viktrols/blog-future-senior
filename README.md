...
<h2>Future Senior - это социальная сеть для публикации постов, в которой можно:</h2>
...
<li>создавать, редактировать, удалять и просматривать свои группы и вступать в созданные другими пользователями</li>
